...
model G3 "Generation unit connected to bus 32"
  extends Plant(
  ...
  GUDynamics gUDynamics(redeclare record GUnitDynamics = OpenIPSL.Data.PowerPlant.PESTR18.NewEngland39.NE39Unit3)
