...
model G1 "Generation unit connected to bus 39"
  extends Plant(
  ...
  GUDynamics gUDynamics(redeclare record GUnitDynamics = OpenIPSL.Data.PowerPlant.PESTR18.NewEngland39.NE39Unit1)
