...
model G4 "Generation unit connected to bus 33"
  extends Plant(
  ...
  GUDynamics gUDynamics(redeclare record GUnitDynamics = OpenIPSL.Data.PowerPlant.PESTR18.NewEngland39.NE39Unit4)
